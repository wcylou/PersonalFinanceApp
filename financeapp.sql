...
GRANT SELECT ON TABLE `personal_finance_app`.* TO 'user'@'localhost';
GRANT SELECT, INSERT, TRIGGER ON TABLE `personal_finance_app`.* TO 'user'@'localhost';
GRANT SELECT, INSERT, TRIGGER, UPDATE, DELETE ON TABLE `personal_finance_app`.* TO 'user'@'localhost';
